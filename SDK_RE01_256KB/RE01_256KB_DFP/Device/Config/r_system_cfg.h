 ...
 *         : 24.11.2020 1.10     Corrected the Event Link definitions.
...
#define SYSTEM_CFG_EVENT_NUMBER_WUPT_OVI            (SYSTEM_IRQ_EVENT_NUMBER_NOT_USED)  /*!< Numbers 0/8/16/24 only */
#define SYSTEM_CFG_EVENT_NUMBER_SOL_DH              (SYSTEM_IRQ_EVENT_NUMBER_NOT_USED)  /*!< Numbers 0/8/16/24 only */
#define SYSTEM_CFG_EVENT_NUMBER_AGTW0_AGTI          (SYSTEM_IRQ_EVENT_NUMBER_NOT_USED)  /*!< Numbers 0/8/16/24 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_AGTW0_AGTCMBI       (SYSTEM_IRQ_EVENT_NUMBER_NOT_USED)  /*!< Numbers 1/9/17/25 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_AGTW1_AGTI          (SYSTEM_IRQ_EVENT_NUMBER_NOT_USED)  /*!< Numbers 2/10/18/26 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_AGTW0_AGTCMAI       (SYSTEM_IRQ_EVENT_NUMBER_NOT_USED)  /*!< Numbers 3/11/19/27 only */
#define SYSTEM_CFG_EVENT_NUMBER_AGT0_AGTI           (SYSTEM_IRQ_EVENT_NUMBER_NOT_USED)  /*!< Numbers 3/11/19/27 only */
#define SYSTEM_CFG_EVENT_NUMBER_AGTW1_AGTCMAI       (SYSTEM_IRQ_EVENT_NUMBER_NOT_USED)  /*!< Numbers 3/11/19/27 only */
