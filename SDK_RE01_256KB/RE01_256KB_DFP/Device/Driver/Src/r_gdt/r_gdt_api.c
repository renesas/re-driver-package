...
*         : 18.02.2020 0.80     Tentatively Fixed defect of v_gdt_cpuline_byte_rd_gdt_limit function.
*         : 26.08.2020 1.10     Replace asm("nop"); with __NOP();
**********************************************************************************************************************/
/******************************************************************************************************************//**
...
static st_gdt_resources_t gs_gdt_resources DATA_LOCATION_PRV_DMAC_RESOURCES = 
{
   ...
   (DMAC0_Type*)DMAC1, /* DMAC1 register base address */
   (DMAC0_Type*)DMAC2, /* DMAC2 register base address */
   (DMAC0_Type*)DMAC3, /* DMAC3 register base address */
