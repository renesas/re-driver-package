...
*         : 22.11.2018 0.60     Driver Version Update
*         : 18.03.2019 0.70     Driver Version Update
*                               Rename sction config defines.
...
*         : 05.01.2021 1.40     Add "DTC_CFG_R_DTC_GET_AVAILABILITY_SRC" and "DTC_CFG_R_DTC_RELEASE"
***********************************************************************************************************************/
...
#define DTC_CFG_R_DTC_GET_AVAILABILITY_SRC  (SYSTEM_SECTION_CODE)         ///< R_DTC_GetAvailabilitySrc() section
#define DTC_CFG_R_DTC_RELEASE               (SYSTEM_SECTION_CODE)         ///< R_DTC_Release() section
