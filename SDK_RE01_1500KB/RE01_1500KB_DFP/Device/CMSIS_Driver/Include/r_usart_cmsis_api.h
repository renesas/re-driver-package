...
*                               Added two functions, sci_clear_irq_req () and sci_disable_irq ().
*         : 05.12.2018 0.60     Added transmit / receive function by DMAC/DTC.
*                               - Added definition of USART_FLAG_TX_AVAILABLE / USART_FLAG_RX_AVAILABLE
*                               - Add definition of event signal used when using DMAC
*                               - Change USART resource (st_usart_resources_t) contents
*                               Adapted to GSCE coding rules.
*                               Compatible with GCC compiler
*                               Changed file name to r_usart_cmsis_api.h
*         : 22.01.2019 0.61     Delete DMA IRQ information from resource.
...
*         : 05.01.2021 1.40     Add sci_close_dma() function
**********************************************************************************************************************/
