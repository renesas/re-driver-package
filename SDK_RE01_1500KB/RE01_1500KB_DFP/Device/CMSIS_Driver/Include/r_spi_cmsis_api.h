...
*                               Fixed type "st_spi_resources_t :: ss_pin" to "volatile uint16_t".
*         : 18.12.2018 0.60     Fixed for WS2 update
*                               Compatible with GCC compiler
*                               Adapted to GSCE coding rules.
*                               Changed file name to r_spi_cmsis_api.h
...
*         : 05.01.2021 1.40     Add spi_close_dma() function
**********************************************************************************************************************/
