...
*         : 31.10.2018 0.51     Update comments
*         : 17.12.2018 0.60     Compatible with GCC compiler
*                               Adapted to GSCE coding rules.
*                               Changed file name to r_i2c_cmsis_api.c
*         : 20.02.2019 0.61     Move RIIC_ADDR_NONE definition from r_i2c_cmsis_api.h to R_Driver_I2C.h
*         : 28.02.2019 0.70     Change the rise time and fall time of the SCL signal so that it can be set by config
*                               Addition of valid / invalid switch for automatic calculation of bus speed
*         : 16.05.2019 0.72     Bug Fix: Fixed the phenomenon that GetStatus is not allocated to RAM
*         : 16.07.2019 1.00     Upgrade version to 1.00
*         : 11.10.2019 1.01     Fixed an error in the definition name
*         : 19.02.2020 1.10     Change of ACKWP bit protection setting method
**********************************************************************************************************************/
...
/******************************************************************************
 Macro definitions
 *****************************************************************************/
#define ARM_I2C_PRV_DRV_VERSION    (ARM_DRIVER_VERSION_MAJOR_MINOR(1, 10)) /*!< driver version */
