...
******************************************************************************/
/******************************************************************************
 * File Name    : r_usb_basic_mini_api.h
...
#include "pin.h"
#include "r_usb_basic_mini_cfg.h"

#include "Driver_USBD.h"

#ifndef R_USB_BASIC_MINI_API_H
#define R_USB_BASIC_MINI_API_H
...
#define USB_DT_HID                              (0x21u)   /* HID descriptor */
#define USB_DT_REPORT                           (0x22u)   /* REPORT descriptor */
...
#if (USB_CFG_FUNC == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_PRV_DRIVER_USB       __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#define DATA_LOCATION_PRV_DRIVER_USB       __attribute__ ((section(".ramdata"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_PRV_DRIVER_USB
#define DATA_LOCATION_PRV_DRIVER_USB
#endif
 ...
 ******************************************************************************/
void     R_USB_ControlDriver (void) FUNC_LOCATION_PRV_DRIVER_USB;

#endif /* R_USB_BASIC_MINI_API_H */
