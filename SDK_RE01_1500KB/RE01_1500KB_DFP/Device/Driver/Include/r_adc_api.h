...
*         : 04.10.2018 0.51     Update comments
*                               Fixed definition name of "ADC_SignalEvent_t" to "adc_cd_event_t".
*         : 20.12.2018 0.60     Changed the AN terminal definition as AN18 and AN19 were deleted in WS2.
*                               Adapted to GSCE coding rules.
*                               Changed file name to r_adc_api.c
*         : 06.02.2019 0.70     Added note to Doxygen comment.
*                               Added DMA linkage definition.
*                               Supports WCMPM / UM interrupt.
*                               Modify the value of ADC_SSEL_TEMP from 40 to 32.
*         : 04.06.2019 0.72     r_adc_cfg.h Update comments
*         : 16.07.2019 1.00     IO register header name change(E017.h -> RE01_1500KB.h)
*                               Upgrade version to 1.00
*         : 11.10.2019 1.01     Upgrade version to 1.01
*         : 01.04.2020 1.20     Fixed not to include header file when DMA is not used.
*         : 05.01.2021 1.40     Add adc_close_dma() function
***********************************************************************************************************************/
/******************************************************************************************************************//**
...
#define ADC_VERSION_MINOR               (40)                          /*!< Minor Version */
...
#define ADC_MSEL_AN22  (1 << 22)                                      /*!< Select AN22 */
#define ADC_MSEL_AN23  (1 << 23)                                      /*!< Select AN23 */
#define ADC_MSEL_AN24  (1 << 24)                                      /*!< Select AN24 */
#define ADC_MSEL_AN25  (1 << 25)                                      /*!< Select AN25 */
#define ADC_MSEL_AN26  (1 << 26)                                      /*!< Select AN26 */
#define ADC_MSEL_AN27  (1 << 27)                                      /*!< Select AN27 */
#define ADC_MSEL_AN28  (1 << 28)                                      /*!< Select AN28 */
/* @} */
...
typedef enum
{
    ...
    AD_CMD_SET_SAMPLING_AN016_AN017_AN020_TO_AN028, /*!< Change the sampling state of AN016    */
...
typedef enum
{
    ...
    ADC_SSEL_AN22 = 22,       /*!< Read ADDR22 */
    ADC_SSEL_AN23 = 23,       /*!< Read ADDR23 */
    ADC_SSEL_AN24 = 24,       /*!< Read ADDR24 */
    ADC_SSEL_AN25 = 25,       /*!< Read ADDR25 */
    ADC_SSEL_AN26 = 26,       /*!< Read ADDR26 */
    ADC_SSEL_AN27 = 27,       /*!< Read ADDR27 */
    ADC_SSEL_AN28 = 28,       /*!< Read ADDR28 */
...
typedef struct 
{            
    volatile S14AD_Type     *reg;               /*!< Base pointer to AD registers  */
