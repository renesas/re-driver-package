 ...
 *         : 25.12.2018 0.60     Update the minor version.
 *                               Adapted to GSCE coding rules.
 *                                - Changed file name to r_system_api.h
 *                               Update Doxygen comments.
 *         : 19.02.2019 0.61     Added R_SYS_SystemClockDividerSet() function.
 *         : 05.03.2019 0.70     Change return value type "uint16_t" to "uint32_t" in R_SYS_GetVersion().
 *         : 28.05.2019 0.72     Added r_sys_BoostFlagGet() function.
 *                               Added r_sys_BoostFlagSet() function.
 *                               Added r_sys_BoostFlagClr() function.
 *                               Added r_sys_BoostFlagGet() to ".ramfunc" section.
 *                               Added r_sys_BoostFlagClr() to ".ramfunc" section.
 *         : 23.07.2019 1.00     Added r_system_wdt_refresh() function.
 *                               Change the product name to RE Family.
 *                                - Change the include file names
 *                                - Update comments
 *         : 23.07.2019 1.01     Update the minor version.
 *         : 02.03.2020 1.10     Added the SYSTEM_REG_PROTECT_LPC_LDO to e_system_reg_protect_t.
 *         : 28.08.2020 1.20     Update the minor version.
 *         : 24.11.2020 1.30     Update the minor version.
 *         : 12.05.2021 1.40     Update R_NVIC_EnableIRQ() function.
...
#define SYSTEM_VERSION_MINOR                (64)
...
#endif
#if (SYSTEM_CFG_SECTION_R_SYS_32KHZSPEEDMODESET == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_SYS_32KHZSPEEDMODESET   __attribute__ ((section(".ramfunc")))   /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_SYS_32KHZSPEEDMODESET
#endif
...
#endif
#if (SYSTEM_CFG_SECTION_R_SYS_SYSTEMCLOCKPLLSET == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_SYS_SYSTEMCLOCKPLLSET   __attribute__ ((section(".ramfunc")))   /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_SYS_SYSTEMCLOCKPLLSET
#endif
...
#endif
#if (SYSTEM_CFG_SECTION_R_SYS_PLLSPEEDCLOCKSTART == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_SYS_PLLSPEEDCLOCKSTART      __attribute__ ((section(".ramfunc")))   /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_SYS_PLLSPEEDCLOCKSTART
#endif
#if (SYSTEM_CFG_SECTION_R_SYS_PLLSPEEDCLOCKSTOP == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_SYS_PLLSPEEDCLOCKSTOP       __attribute__ ((section(".ramfunc")))   /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_SYS_PLLSPEEDCLOCKSTOP
#endif
...
typedef enum e_system_reg_protect
{
    SYSTEM_REG_PROTECT_CGC = 0,     /*!< Enables writing to the registers related to the clock generation circuit.@n
                                         SCKDIVCR, SCKSCR, PLLCCR, PLLCR, MOSCCR, HOCOCR, HOCOMCR, MOCOCR,
...
int32_t R_SYS_32kHzSpeedModeSet(void)           FUNC_LOCATION_R_SYS_32KHZSPEEDMODESET;
...
int32_t R_SYS_SystemClockPLLSet(void)           FUNC_LOCATION_R_SYS_SYSTEMCLOCKPLLSET;
...
int32_t R_SYS_PLLSpeedClockStart(void)          FUNC_LOCATION_R_SYS_PLLSPEEDCLOCKSTART;
int32_t R_SYS_PLLSpeedClockStop(void)           FUNC_LOCATION_R_SYS_PLLSPEEDCLOCKSTOP;
