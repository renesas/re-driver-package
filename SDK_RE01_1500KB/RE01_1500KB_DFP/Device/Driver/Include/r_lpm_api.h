 ...
 *         : 24.10.2018 0.51     Implement measures to speed up processing.
 ...
 *                               Fixed wrong macro name used in R_LPM_SSTBYModeSetup() function.
 *                                 - LPM_SSTBY_WUP_SOLHD -> LPM_SSTBY_WUP_SOLDH
 ...
 *                               Added macro of version information.
 *                               Partly compatible with GSCE rules.
 *                               Added ingroup at header.
 ...
 *                               Fix LPM_IOPOWER_SUPPLY definition value from 32 bits
 *         : 27.02.2019 0.61     Added R_LPM_GetVersion() function.
 *         : 24.04.2019 0.70     Changed the comment for Doxygen.
 *                               Changed the version 0.61 to 0.70.
 *                               Added LPM_DSTBY_RESET_LVDBAT to the definition of LPM_DSTBY_RESET.
 *                               Added following member to the definition of LPM_SSTBY_WUP.
 *                                 LPM_SSTBY_WUP_IRQ8, LPM_SSTBY_WUP_IRQ9, LPM_SSTBY_WUP_LVDBAT
 *                               Changed LPM_SSTBY_WUP member LPM_SSTBY_WUP_AGT1CB to LPM_SSTBY_WUP_AGT0CA.
 *                               Added LPM_DSTBY_WUP_LVDBAT to the definition of LPM_DSTBY_WUP.
 *                               Added LPM_DSTBY_WUP_EDGE_LVDBAT to the definition of LPM_DSTBY_WUP_EDGE.
 *                               Changed LPM_SNZ_REQ member LPM_SNZ_REQ_AGT1CB to LPM_SNZ_REQ_AGT0CA.
 *                               Deleted LPM_SNZ_WUP_KEY_INTKR from the member of e_lpm_snz_wup_t.
 *         : 22.05.2019 0.72     Changed the version 0.70 to 0.72.
 *                               Changed the comment for Doxygen.
 *                               Added LPM_FAST_MSTP_C_DIL to the definition of LPM_FAST_MSTPT_C.
 *                               Added LPM_MSTP_DIL to the member of e_lpm_mstp_t.
...
#define LPM_FAST_MSTP_B_USB           (0x00000800UL)          /*!< USB module */
...
#define LPM_FAST_MSTP_B_ALL           (0xFC4C0B60UL)          /*!< Set all modules belonging to MSTP_B */
...
#define LPM_FAST_MSTP_C_LED           (0x00000400UL)          /*!< LED module */
...
#define LPM_FAST_MSTP_C_ALL           (0x8640E403UL)          /*!< Set all modules belonging to MSTP_C */
...
#define LPM_FAST_MSTP_D_LPG           (0x00000010UL)          /*!< LPG module */
...
#define LPM_FAST_MSTP_D_MTDV          (0x00000100UL)          /*!< MTDV module */
...
#define LPM_FAST_MSTP_D_R12DA         (0x00100000UL)          /*!< R12DA module */
#define LPM_FAST_MSTP_D_TEMPS         (0x00400000UL)          /*!< TEMPS module */
#define LPM_FAST_MSTP_D_ACMP          (0x10000000UL)          /*!< ACMP module */
#define LPM_FAST_MSTP_D_NONE          (0x00000000UL)          /*!< Set no module belonging to MSTP_D */
#define LPM_FAST_MSTP_D_ALL           (0x105341FFUL)          /*!< Set all modules belonging to MSTP_D */
...
#define LPM_DSTBY_RESET_CCC             (0x2000UL)          /*!< CCC interval intterupt singnal */
...
#define LPM_RAM_RETENTION_AREA4         (0x10UL)          /*!< The data in the following address is retained. 0x20020000 - 0x20027FFF */
#define LPM_RAM_RETENTION_AREA5         (0x20UL)          /*!< The data in the following address is retained. 0x20028000 - 0x2002FFFF */
#define LPM_RAM_RETENTION_AREA6         (0x40UL)          /*!< The data in the following address is retained. 0x20030000 - 0x20037FFF */
#define LPM_RAM_RETENTION_AREA7         (0x80UL)          /*!< The data in the following address is retained. 0x20038000 - 0x2003FFFF */
#define LPM_RAM_RETENTION_NONE          (0x00UL)          /*!< Set no factor (Default) */
#define LPM_RAM_RETENTION_ALL           (0xFFUL)          /*!< Set all factor */
...
#define LPM_SSTBY_WUP_ACMP0             (0x00800000UL)          /*!< ACMP0 interrupt */
...
#define LPM_SSTBY_WUP_USBFS             (0x08000000UL)          /*!< USBFS interrupt */
...
#define LPM_DSTBY_WUP_CCC               (0x2000UL)          /*!< CCC interval intterupt singnal */
#define LPM_DSTBY_WUP_NONE              (0x0000UL)          /*!< Set no factor (Default) */
#define LPM_DSTBY_WUP_ALL               (0x330FUL)          /*!< Set all factor */
...
#define LPM_SNZ_REQ_ACMP0               (0x00800000UL)          /*!< ACMP0 interrupt */
 ...
 * @defgroup LPM_IOPOWER_SUPPLY
          ...
          For example. If AVCC0 and AVCC1 domains cannot be supplied then please set argument "LPM_IOPOWER_SUPPLY_AVCC0"
          and "LPM_IOPOWER_SUPPLY_AVCC1" for R_LPM_IOPowerSupplyModeSet().\n
          E.g.:Enable the function for AVCC0 and AVCC1 domain. Other domains are set to disabled.\n
          R_LPM_IOPowerSupplyModeSet(LPM_IOPOWER_SUPPLY_AVCC0 | LPM_IOPOWER_SUPPLY_AVCC1);
 */
/* @{ */
#define LPM_IOPOWER_SUPPLY_AVCC0        (0x01)            /*!< when power cannot be supplied to AVCC0   : S14AD, TEMPS, VREF */
#define LPM_IOPOWER_SUPPLY_AVCC1        (0x02)            /*!< when power cannot be supplied to AVCC1   : R12DA and ACMP */
#define LPM_IOPOWER_SUPPLY_IOVCC0       (0x04)            /*!< when power cannot be supplied to IOCC0   : PORT8 */
#define LPM_IOPOWER_SUPPLY_IOVCC1       (0x08)            /*!< when power cannot be supplied to IOCC1   : PORT3, PORT6, PORT7 and P202-P204 */
#define LPM_IOPOWER_SUPPLY_IOVCC2       (0x10)            /*!< when power cannot be supplied to IOCC2   : PORT1 */
#define LPM_IOPOWER_SUPPLY_IOVCC3       (0x20)            /*!< when power cannot be supplied to IOCC3   : P010-P015 and PORT5 */
#define LPM_IOPOWER_SUPPLY_USBVCC       (0x40)            /*!< when power cannot be supplied to USB_VCC : USB */
#define LPM_IOPOWER_SUPPLY_MTDV         (0x80)            /*!< when power cannot be supplied to MTDV    : MTDV */
#define LPM_IOPOWER_SUPPLY_NONE         (0x00)            /*!< when power can be supplied to all power domain : Set no factor */
#define LPM_IOPOWER_SUPPLY_ALL          (0xFF)            /*!< when power can NOT be supplied to any power domain other than VCC/IOVCC : Set all factor (Default) */
 ...
 */
/* @{ */
/** @brief Select power supply mode when transitioning from opration mode to Software Standby mode. */
typedef enum e_lpm_ope_to_sstby_power_supply_mode
{
    LPM_OPE_TO_SSTBY_ALLPWON_TO_EXFPWON,    /*!< Transition from ALLPWON operation mode to EXFPWON Software Standby mode. (Default) */
    LPM_OPE_TO_SSTBY_ALLPWON_TO_MINPWON,    /*!< Transition from ALLPWON operation mode to MINPWON Software Standby mode.  */
    LPM_OPE_TO_SSTBY_EXFPWON_TO_EXFPWON,    /*!< Transition from EXFPWON operation mode to EXFPWON Software Standby mode.  */
    LPM_OPE_TO_SSTBY_EXFPWON_TO_MINPWON,    /*!< Transition from EXFPWON operation mode to MINPWON Software Standby mode.  */
    LPM_OPE_TO_SSTBY_MINPWON_TO_MINPWON     /*!< Transition from MINPWON operation mode to MINPWON Software Standby mode.  */
} e_lpm_ope_to_sstby_power_supply_mode_t;
 ...
 */
/* @{ */
/** @brief Select power supply mode when transitioning from Software Standby mode to opration mode. */
typedef enum e_lpm_sstby_to_ope_power_supply_mode
{
    LPM_SSTBY_TO_OPE_EXFPWON_TO_ALLPWON,    /*!< Transition from EXFPWON Software Standby mode to ALLPWON operation mode. (Default) */
    LPM_SSTBY_TO_OPE_EXFPWON_TO_EXFPWON,    /*!< Transition from EXFPWON Software Standby mode to EXFPWON operation mode.  */
    LPM_SSTBY_TO_OPE_MINPWON_TO_MINPWON     /*!< Transition from MINPWON Software Standby mode to MINPWON operation mode.  */
} e_lpm_sstby_to_ope_power_supply_mode_t;
...
{
    e_lpm_ope_to_sstby_power_supply_mode_t  ope_sstby;      /*!< Select power supply mode when transitioning from opration mode to Software Standby mode.  */
    e_lpm_sstby_to_ope_power_supply_mode_t  sstby_ope;      /*!< Select power supply mode when transitioning from Software Standby mode to opration mode.  */
