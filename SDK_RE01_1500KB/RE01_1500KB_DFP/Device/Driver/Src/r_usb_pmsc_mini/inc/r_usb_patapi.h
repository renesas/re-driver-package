...
typedef enum
{
    ...
    USB_ATAPI_COMMAND_PACET_SIZE            = 8
...
void        pmsc_atapi_analyze_cbwcb(uint8_t *p_cbwcb) FUNC_LOCATION_PRV_DRIVER_USB;
void        pmsc_atapi_command_processing(uint8_t *p_cbw, uint16_t status) FUNC_LOCATION_PRV_DRIVER_USB;
void        pmsc_atapi_init (void) FUNC_LOCATION_PRV_DRIVER_USB;
