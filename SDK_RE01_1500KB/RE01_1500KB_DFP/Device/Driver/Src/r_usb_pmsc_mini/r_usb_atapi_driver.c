...
#include "r_usb_media_driver_mini_api.h"
 ...
 ******************************************************************************/
extern void     usb_pmsc_data_transfer (uint16_t status, void *p_adr, uint32_t size);

/******************************************************************************
 Private global variables and functions
 ******************************************************************************/
static void             pmsc_atapi_get_read_data(uint32_t *p_size, uint8_t **pp_buff) FUNC_LOCATION_PRV_DRIVER_USB;
...
static const uint8_t gs_usb_atapi_inquiry_header[USB_ATAPI_COMMAND_PACET_SIZE] DATA_LOCATION_PRV_DRIVER_USB = 
{
...
static const uint8_t gs_usb_atapi_vendor[USB_ATAPI_INQUIRY_VENDOR_SIZE] DATA_LOCATION_PRV_DRIVER_USB = 
{
    USB_CFG_PMSC_VENDOR
};
static const uint8_t gs_usb_atapi_product[USB_ATAPI_INQUIRY_PRODUCT_SIZE] DATA_LOCATION_PRV_DRIVER_USB = 
{
    USB_CFG_PMSC_PRODUCT
};
static const uint8_t gs_usb_atapi_revision[USB_ATAPI_INQUIRY_REVISION_SIZE] DATA_LOCATION_PRV_DRIVER_USB = 
{
...
/* Request Sense data */
static const uint8_t   gs_usb_atapi_rs_tbl[USB_ATAPI_REQUEST_SENSE_SIZE] DATA_LOCATION_PRV_DRIVER_USB =
{
...
#if 1
static const uint8_t   gs_usb_atapi_ms_mp_tbl[USB_ATAPI_MODE_SENSE10_MODE_PARAM_SIZE] DATA_LOCATION_PRV_DRIVER_USB =
{
...
#endif
//static uint8_t   gs_usb_atapi_ms_mp_tbl[USB_ATAPI_MODE_SENSE10_MODE_PARAM_SIZE];

/* Mode Sense data (ReadWrite Error Recovery Page 12byte) */
static const uint8_t   gs_usb_atapi_ms_rcvr_tbl[USB_ATAPI_MODE_SENSE10_ERR_RCVR_P_SIZE] DATA_LOCATION_PRV_DRIVER_USB =
{
    /* Mode Parameter List */
    0x00,   /* [0]Mode Data Length */
...
static const uint8_t   gs_usb_atapi_ms_cash_tbl[USB_ATAPI_MODE_SENSE10_CASHING_P_SIZE] DATA_LOCATION_PRV_DRIVER_USB =
{
    /* Mode Parameter List */
    0x00,   /* [0]Mode Data Length */
    0x0C,   /* [1]Mode Data Length */
...
static const uint8_t   gs_usb_atapi_ms_capa_tbl[USB_ATAPI_MODE_SENSE10_CAP_P_SIZE] DATA_LOCATION_PRV_DRIVER_USB =
{
    /* Mode Parameter List */
    0x00,   /* [0]Mode Data Length */
    0x0C,   /* [1]Mode Data Length */
...
static const uint8_t   gs_usb_atapi_ms_op_cmd_tbl[USB_ATAPI_MODE_SENSE10_OP_CMD_SIZE] DATA_LOCATION_PRV_DRIVER_USB =
{
    /* Mode Parameter List */
    0x00,   /* [0]Mode Data Length */
...
static const uint8_t   gs_usb_atapi_ms_all_tbl[USB_ATAPI_MODE_SENSE10_ALL_P_SIZE] DATA_LOCATION_PRV_DRIVER_USB =
{
    /* Mode Parameter List */
    0x00,   /* [0]Mode Data Length */
...
static const uint8_t   gs_usb_atapi_ms_err_tbl[USB_ATAPI_MODE_SENSE10_P_CODE_ERR_SIZE] DATA_LOCATION_PRV_DRIVER_USB =
{
    0x00,   /* [0]Mode Data Length */
    0x00,   /* [1]Mode Data Length */
    0x00,   /* [2]Medium Type Code(00h-FFh Vendor Specific) */
...
static const uint8_t   gs_usb_atapi_dummy_tbl[] DATA_LOCATION_PRV_DRIVER_USB =
{
...
static void pmsc_atapi_get_read_data(uint32_t *p_size, uint8_t **pp_buff)
{
    ...
    switch (gsp_usb_atapi_cbwcb->s_usb_ptn0.uc_opcode)
    {
        ...
        case USB_ATAPI_INQUIRY:
            /* Casting void*/
            memcpy((void *)&gs_usb_atapi_inquiry_tbl[0], gs_usb_atapi_inquiry_header, USB_ATAPI_COMMAND_PACET_SIZE);
            /* Casting void*/
            memcpy((void *)&gs_usb_atapi_inquiry_tbl[8], gs_usb_atapi_vendor, USB_ATAPI_INQUIRY_VENDOR_SIZE);
            /* Casting void*/
            memcpy((void *)&gs_usb_atapi_inquiry_tbl[16], gs_usb_atapi_product, USB_ATAPI_INQUIRY_PRODUCT_SIZE);
            /* Casting void*/
            memcpy((void *)&gs_usb_atapi_inquiry_tbl[32], gs_usb_atapi_revision, USB_ATAPI_INQUIRY_REVISION_SIZE);
        ...
        case USB_ATAPI_READ_FORMAT_CAPACITY:
            ...
            gs_usb_atapi_read_f_capa_tbl[0]    = 0x00;      /* MSB */
            gs_usb_atapi_read_f_capa_tbl[1]    = 0x00;
            gs_usb_atapi_read_f_capa_tbl[2]    = 0x00;
            gs_usb_atapi_read_f_capa_tbl[3]    = 0x10;      /* LSB */
 ...
 ******************************************************************************/
void pmsc_atapi_command_processing(uint8_t *p_cbw, uint16_t usb_result)
{
    ...
    usb_pmsc_data_transfer (status, p_atapi_rw_buff, this_transfer_size);
...
//            memset(gs_usb_atapi_ms_mp_tbl, 0, sizeof(gs_usb_atapi_ms_mp_tbl));
            /* Casting uint8_t* */
