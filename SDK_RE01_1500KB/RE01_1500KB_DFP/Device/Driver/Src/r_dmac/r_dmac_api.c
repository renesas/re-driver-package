...
*                                 in r_dmac_api.c
*                               Changed file name to r_dmac_api.c
...
*         : 07.03.2019 0.70     Fix DMAC transfer start procedure according to manual rev.0.70
...
*         : 05.01.2021 1.40     Add "R_DMAC_GetAvailabilitySrc" and "R_DMAC_Release"
**********************************************************************************************************************/
