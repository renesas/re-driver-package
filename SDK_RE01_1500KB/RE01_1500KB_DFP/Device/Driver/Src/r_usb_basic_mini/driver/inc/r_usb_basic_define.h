...
#else   /* ARM_MATH_BIG_ENDIAN */
#define    USB_CFG_ENDIAN           (USB_CFG_LITTLE)
#endif  /* ARM_MATH_BIG_ENDIAN */

#define USB_TATTDB          (4500)    /* (Chapter 7.1.7.3 TATTDB) minimum duration of 100 ms */
...
/* SOTB Add */
#define USBI_FS                 (0x12)              /* USBFS Event Link Number */
#define USBR_FS                 (0x14)              /* USBFS Event Link Number */
#define D0FIFO_FS               (0x15)
#define D1FIFO_FS               (0x14)

#define USBFS_D0FIFO_ICU_EVENT_NO   (0x2b)
#define USBFS_D1FIFO_ICU_EVENT_NO   (0x2c)
