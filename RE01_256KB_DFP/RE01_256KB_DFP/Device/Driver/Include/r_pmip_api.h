...
*                               Fixed the problem that R_PMIP_Send function is not allocated to RAM
...
typedef enum
{
    ...
    PMIP_ERROR_VCOM_MASK_CFG         = 14,              /*!< MLCD fmask/bmask config failed  */
    PMIP_ERROR_TIMEOUT               = 15               /*!< MLCD timeout failed             */
} e_pmip_err_t;
