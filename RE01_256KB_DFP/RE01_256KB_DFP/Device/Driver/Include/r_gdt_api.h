...
*         : 18.02.2020 0.80     Upgrade version to 0.80
*         : 26.08.2020 1.10     Upgrade version to 1.10
***********************************************************************************************************************/
#ifndef R_GDT_API_H
#define R_GDT_API_H
...
{           
    ...
    volatile DMAC0_Type     *reg_dmac1;            /*!< Base pointer to DMAC1 registers     */
    volatile DMAC0_Type     *reg_dmac2;            /*!< Base pointer to DMAC2 registers     */
    volatile DMAC0_Type     *reg_dmac3;            /*!< Base pointer to DMAC3 registers     */
