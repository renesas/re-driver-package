...
*         : 27.08.2020 1.10     Fixed the problem that the dtc_cmd_refresh function could not allocate RAM
*         : 05.01.2021 1.20     Add "R_DTC_GetAvailabilitySrc" and "R_DTC_Release"
**********************************************************************************************************************/
