...
*         : 10.04.2020 1.00     Fixed the problem that AGT register value could not be rewritten when Kyocera LCD is used.
...
#define SMIP_PRV_VERSION_MINOR          (00)        /*!< Minor Version */
...
#else
        if(1U == SYSC->LOCOCR_b.LCSTP)     /* @suppress("Cast comment") */
        {
