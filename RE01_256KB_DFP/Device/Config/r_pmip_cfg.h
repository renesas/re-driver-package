...
*         : 30.01.2020 0.80     VCOM wait time changed from software wait to hardware wait.
...
*         : 27.08.2020 1.10     Corrected comments according to "User's Manual:Hardware(R01UH0894)"
*         : 12.01.2021 1.20     Add "PMIP_CFG_R_PMIP_RECONFIG"
***********************************************************************************************************************/
#ifndef R_PMIP_CFG_H
#define R_PMIP_CFG_H
...
/* VCOM mask time before data transmission                               */
/* This value converts to cycle for FMASK[7:0] bit value                 */
/* Note: Maximum sampling period (488us) is generated from the set value */
/*       When set to 4000us, the waiting time is 4392us(488us*9)         */
#define PMIP_CFG_FMASK_US       (4000)

/* VCOM mask time after data transmission                                */
/* This value converts to cycle for BMASK[7:0] bit value                 */
/* Note: Maximum sampling period (488us) is generated from the set value */
/*       When set to 1000us, the waiting time is 1464us(488us*3)         */
#define PMIP_CFG_BMASK_US       (1000)
